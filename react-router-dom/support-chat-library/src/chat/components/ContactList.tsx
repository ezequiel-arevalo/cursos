    ...
    <ScrollArea className="h-[calc(100vh-64px)]">
      <div className="space-y-4 p-4">
        <div className="space-y-1">
          ...
          <div className="space-y-1">
            <NavLink to={"/chat/"} className="flex items-center w-full py-1.5 ml-4 justify-start cursor-pointer">
              <div className="h-6 w-6 rounded-full bg-blue-500 mr-2 flex-shrink-0 flex items-center justify-center text-white text-xs">
                G5
              </div>
              G5 Customer
            </NavLink>
            <NavLink to={"/chat/1"} className="flex items-center w-full py-1.5 ml-4 justify-start cursor-pointer">
              <div className="h-6 w-6 rounded-full bg-green-500 mr-2 flex-shrink-0 flex items-center justify-center text-white text-xs">
                JD
              </div>
              John Doe
            </NavLink>
            <NavLink to={"/chat/2"} className="flex items-center w-full py-1.5 ml-4 justify-start cursor-pointer">
